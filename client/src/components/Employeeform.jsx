...
function Employeeform() {
  ...
  return (
    <div className="mt-4 container">
      <h3 className="mb-4 text-center fw-bold">Employee Form</h3>
      <form onSubmit={handleSubmit} className="shadow-sm p-3 p-md-4 card">
        ...
        <div className="d-flex flex-wrap justify-content-center gap-2 mt-3">
          <button className="px-4 btn btn-primary btn-sm">{editId ? "Update" : "Add"}</button>
          <button type="button" className="px-4 btn btn-secondary btn-sm" onClick={handleCancel}>Cancel</button>
        </div>
      </form>
